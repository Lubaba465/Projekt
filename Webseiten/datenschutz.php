...
<head>
    ...
    <title>Datenschutz - Burgen in Europa</title>
...
<body>
    ...
    <div class="center">
        ...
        <p><span class="tsmcontroller"> Burgen In Europa<br>
                Musterstraße 12<br>
                12345 Musterstadt<br>
                Musterland<br>
                <br>
                E-Mailadresse: burgenineuropa@example.com<br>
                Geschäftsführer/ Inhaber: Gruppe Burgen In Europa<br>
                Link zum Impressum: http://….de<br>
                <br>
                Kontakt Datenschutzbeauftragte/r: joedoe@example.com</span></p>
        ...
        <p>Auskunftsrecht: Sie haben das Recht, eine Bestätigung darüber zu verlangen, ob betreffende Daten verarbeitet werden und auf Auskunft über diese Daten sowie auf weitere Informationen und Kopie der Daten entsprechend den gesetzlichen Vorgaben.<br>
            <br>
        ...
        <p><span class="ts-muster-content">Wenn Nutzer Kommentare oder sonstige Beiträge hinterlassen, können ihre IP-Adressen auf Grundlage unserer berechtigten Interessen im Sinne des Art. 6 Abs. 1 lit. f. DSGVO für 7 Tage gespeichert werden. Das erfolgt zu unserer Sicherheit, falls jemand in Kommentaren und Beiträgen widerrechtliche Inhalte hinterlässt (Beleidigungen, verbotene politische Propaganda, etc.). In diesem Fall können wir selbst für den Kommentar oder Beitrag belangt werden und sind daher an der Identität des Verfassers interessiert.<br>
                ...
                <br>
                Die im Rahmen der Kommentare und Beiträge mitgeteilte Informationen zur Person, etwaige Kontakt- sowie Websiteinformationen als auch die inhaltlichen Angaben, werden von uns bis zum Widerspruch der Nutzer dauerhaft gespeichert.</span></p>
        <p></p>
        ...
        <p></p>
        <h3 id="dsg-fb-messenger">Kommunikation via Facebook-Messenger</h3>
        <p></p>
        <p><span class="ts-muster-content">Wir setzen zu Zwecken der Kommunikation den Facebook-Messenger ein und bitten Sie die nachfolgenden Hinweise zu der Funktionsfähigkeit, der Verschlüsselung, Risiken des Facebook-Messengers, Nutzung der Metadaten innerhalb der Facebook-Unternehmensgruppe und Ihren Widerspruchsmöglichkeiten zu beachten.<br>
        ...
        <p></p>
        <h3 id="dsg-fb-messenger-chatbot">Chatbot im Facebook-Messenger</h3>
        <p></p>
        <p><span class="ts-muster-content">Wir bieten als Kommunikationsmöglichkeit einen so genannten „Chatbot“ an. Bei dem Chatbot handelt es sich um eine Software, die Fragen der Nutzer beantwortet oder sie über Nachrichten informiert. Unser Chat-Bot ist über die „Facebook-Messenger“ Plattform abrufbar.<br>
                <br>
        ...
        <p></p>
        <p><span class="ts-muster-content">Wir binden die Landkarten des Dienstes "OpenStreetMap" ein (<a target="_blank" href="https://www.openstreetmap.de">https://www.openstreetmap.de</a>), die auf Grundlage der Open Data Commons Open Database Lizenz (ODbL) durch die OpenStreetMap Foundation (OSMF) angeboten werden. Datenschutzerklärung: <a target="_blank" href="https://wiki.openstreetmap.org/wiki/Privacy_Policy">https://wiki.openstreetmap.org/wiki/Privacy_Policy</a>. <br>
                <br>
